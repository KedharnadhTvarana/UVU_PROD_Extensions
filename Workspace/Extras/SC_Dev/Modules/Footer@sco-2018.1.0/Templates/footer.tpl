			...
			<div class="footer-content-nav">
				...
				<ul class="footer-content-nav-list">
					...
					<li class="footer-column-link-listitem"><a class="footer-column-link" {{objectToAtrributes item}}
							...
							data-target="{{datatarget}}" {{#if datatarget includeZero=true}}target="_blank"
							{{/if}}>{{text}}</a></li>
					{{else}}
					<li class="footer-column-heading-listitem">
						<h4 class="footer-column-heading" role="region" aria-label="Footer Column Heading">{{text}}</h4>
					</li>
					{{/if}}
					{{/each}}
				</ul>
				...
				<div class="footer-content-social">
					<ul class="footer-content-social-list">
						...
						<li><a {{objectToAtrributes item}} title={{text}} data-hashtag="{{datahashtag}}"
								data-touchpoint="{{datatouchpoint}}" data-target="{{datatarget}}" target="_blank">{{#if
								icon}}<i
