...
<div class="cart-summary">
	<div class="cart-summary-container">
		...
		<div class="cart-summary-expander-container">
			<div class="cart-summary-expander-head">
				<button class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse"
					...
					{{translate 'Estimate Tax &amp; Shipping'}} <i data-toggle="tooltip"
						class="cart-summary-expander-tooltip"
						title="{{translate '<b>Shipping Estimator</b><br>Shipping fees are based on your shipping location. Please enter your information to view estimated shipping costs.'}}"
			...
			<div class="cart-summary-expander-body collapse" id="estimate-shipping-form" role="tabpanel">
				<div class="cart-summary-expander-container">
					<form action="#" data-action="estimate-tax-ship">
						...
						<input name="country" id="country" class="country" value="{{singleCountryCode}}"
							type="hidden" />
						{{else}}
		...
		<div class="cart-summary-message cart-summary-msg-description">
			<p class="cart-summary-login-to-see-price">
				{{translate 'Please <a href="$(0)" data-navigation="ignore-click">log in</a> to see prices or purchase
				items' urlLogin}}
			</p>
		</div>
		{{/if}}
		...
		<div class="cart-summary-expander-head">
			<button class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse"
				...
				<i data-toggle="tooltip" tabindex="0" class="cart-summary-expander-tooltip"
					title="{{translate '<b>Promo Code</b><br>To redeem a promo code, simply enter your information and we will apply the offer to your purchase during checkout.'}}"></i>
	...
	<div class="cart-summary-button-container">
		<a id="btn-proceed-checkout"
			class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}"
		...
		<div class="cart-summary-btn-paypal-express">
			<a href="#" data-touchpoint="checkout" data-hashtag="#" data-parameters="paypalexpress=T">
				<img src="{{paypalButtonImageUrl}}" class="cart-summary-btn-paypal-express-image"
					alt="PayPal Express" />
			</a>
		</div>
		{{/if}}
