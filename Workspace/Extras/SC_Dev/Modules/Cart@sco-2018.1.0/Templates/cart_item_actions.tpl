...
<div class="cart-item-actions-links">
	{{#if isAdvanced}}
	<a href="{{editUrl}}" class="cart-item-actions-item-list-actionable-edit-button-edit"
		data-toggle="show-in-modal">{{translate 'Edit'}} <span class="link-separator">&vert;</span></a>

	{{#if showSaveForLateButton}}
	<a href="#" class="cart-item-actions-item-list-actionable-edit-content-saveforlater"
		data-action="save-for-later-item" data-internalid="{{lineId}}">
