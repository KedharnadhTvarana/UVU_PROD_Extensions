	...
	<div class="cart-promocode-form-summary-grid">
		<div class="cart-promocode-form-summary-container-input">
			<div class="{{#if showErrorMessage}}error{{/if}}">
				...
				<input {{#if isSaving}}disabled{{/if}} type="text" name="promocode" id="promocode"
					class="cart-promocode-form-summary-input" value="{{promocodeCode}}" aria-label="Have a promo code">
			</div>
		</div>
		<div class="cart-promocode-form-summary-promocode-container-button">
			<button type="submit" class="cart-promocode-form-summary-button-apply-promocode" {{#if
				isSaving}}disabled{{/if}}>
				{{translate 'Apply'}}
			</button>
		</div>
	</div>
