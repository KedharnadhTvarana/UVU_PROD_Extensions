...
<div class="cart-item-summary-item-list-actionable-qty">
	<form action="#" class="cart-item-summary-item-list-actionable-qty-form" data-action="update-quantity"
		...
		<input type="hidden" name="internalid" id="update-internalid-{{lineId}}" class="update-internalid-{{lineId}}"
			value="{{lineId}}">
		<label class="cart-item-summary-label"  data-validation="control">
			...
			<div class="cart-item-summary-item-list-actionable-container-qty">
				<label for="quantity-{{lineId}}" class="cart-item-summary-item-list-actionable-label-qty">{{translate
					'Quantity'}}</label>
				<div class="cart-item-summary-item-list-actionable-input-qty">
					<button type="button" class="cart-item-summary-quantity-remove" data-action="minus" {{#if
						isMinusButtonDisabled}}disabled{{/if}}>-</button>
					<input type="number" data-type="cart-item-quantity-input" name="quantity" id="quantity-{{lineId}}"
						class="cart-item-summary-quantity-value quantity-{{lineId}}" value="{{line.quantity}}"
						min="1" />
					<button type="button" class="cart-item-summary-quantity-add" data-action="plus" {{#if
						isPlusButtonDisabled}}disabled{{/if}}>+</button>
