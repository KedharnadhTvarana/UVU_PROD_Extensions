...
<div id="{{cartOptionId}}-container" class="product-views-option-color" data-type="option"
	data-cart-option-id="{{cartOptionId}}" data-item-option-id="{{itemOptionId}}">
	<div class="{{cartOptionId}}-controls-group" data-validation="control-group">
		...
		{{/if}}
		<div class="{{cartOptionId}}-controls product-views-option-color-container {{#if showSmall}}product-views-option-color-container-small{{/if}}"
			data-validation="control">
			<fieldset>
				<legend class="visually-hidden">Legend Hidden text</legend>
				{{#each values}}
				{{#if internalId}}
				<label class="product-views-option-color-picker">
					<div class="product-views-option-color-picker-label">
						<input class="product-views-option-color-picker-input" type="radio" name="{{../cartOptionId}}"
							id="{{../cartOptionId}}" data-action="changeOption" value="{{internalId}}" {{#if
							isActive}}checked{{/if}} data-toggle="set-option" data-active="{{isActive}}"
						...
						<img data-label="label-{{../cartOptionId}}" value="{{internalId}}"
							...
							style="height:{{image.height}};width:{{image.width}}" alt="{{label}}"
