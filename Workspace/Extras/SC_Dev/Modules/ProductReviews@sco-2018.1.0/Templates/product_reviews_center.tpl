	...
	<div class="product-reviews-center-more-info-content-container">
		<div class="product-reviews-center">
			...
			<div class="product-reviews-center-container-footer">
				<a href="{{itemUrl}}/newReview" class="product-reviews-center-container-footer-button">{{translate
					'Write a Review'}}</a>
			</div>
			{{else}}
			<!-- <div class="product-reviews-center-container"> -->
			<div class="product-reviews-center-no-reviews-container">
				...
				<p>{{translate 'Be the first to'}} <a href="{{itemUrl}}/newReview"
						class="product-reviews-center-container-button">{{translate 'Write a Review'}}</a></p>
			</div>
			<!-- </div> -->
			{{/if}}
		</div>
