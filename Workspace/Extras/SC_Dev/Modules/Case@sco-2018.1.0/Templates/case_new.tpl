<script src="https://www.google.com/recaptcha/api.js?render=6Le9VdorAAAAABycy0k5RC7vz8Q8HuqWvOqYS97m" async
	defer></script>
	...
	<form action="#" class="case-new-form" novalidate>
		<div class="case-new-form-controls-group" data-validation="control-group">
			...
			<div class="case-new-form-controls" data-validation="control">
				<input data-action="text" type="text" name="title" id="title" class="case-new-form-input" value=""
					maxlength="300" />
			</div>
		</div>
		...
		<div class="case-new-form-controls-group">
			<label class="case-new-form-label">
				<input data-action="include_email" type="checkbox" name="include_email" id="include_email"
					class="case-new-form-include-email" />
				{{translate 'I want to use another email address for this case'}}

			</label>
		</div>

		<div class="recaptchaaWarnig" style="color:red;"></div>
		...
		<div class="collapse" data-collapse-content data-validation="control-group">
			...
			<div class="case-new-form-controls" data-validation="control">
				<input type="email" autofocus name="email" id="email" placeholder="{{translate 'yourname@company.com'}}"
