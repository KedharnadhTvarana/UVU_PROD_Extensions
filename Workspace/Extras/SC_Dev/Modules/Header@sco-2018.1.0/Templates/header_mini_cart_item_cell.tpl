...
<li class="header-mini-cart-item-cell" data-item-id="{{itemId}}" data-item-type="{{itemType}}">
	<a {{{linkAttributes}}} class="imageAttribute">
		<div class="header-mini-cart-item-cell-image">
			...
			{{/if}}
			<img src="{{resizeImage thumbnail.url 'tinythumb'}}?resizeh=60" alt="{{line.item._name}}">
		</div>
	</a>
	<div class="header-mini-cart-item-cell-details">
		<ul>
			...
			{{else}}
			<li>
				{{translate '<a data-touchpoint="login" data-hashtag="login-register" origin-hash="" href="#">Login</a>
				to see price'}}
			</li>
			{{/if}}
