...
<div class="home">
	...
	{{log 'iam vu' hideCarouselImages}}

	{{#unless hideCarouselImages}}
					...
					<div class="home-slide-main-container
						...
						<div class="home-slide-image-container use-image" style="background-image:url('{{image}}');">
							<a {{objectToAtrributes item}} class="home-slide-wrap-link">
								...
								{{#if imageMobile}}
								<img src="{{imageMobile}}" class="home-slide-image-mobile" aria-label="Mobile Slider" />
								{{/if}}
							</a>
						</div>
						...
						<div class="home-slide-caption-container
							...
							<div class="home-slide-caption {{captionTextAlign}}">
								{{#if title}}<h1 class="home-slide-caption-title" style="color:{{captionColor}}">
									{{{title}}}</h1> {{/if}}
								{{#if text}}<h2 class="home-slide-caption-text" style="color:{{captionColor}}">
									{{{text}}}</h2> {{/if}}
								{{#if linktext}}
	...
	<div class="home-infoblock-layout">
		...
		<div class="home-infoblock">
			<a title="" {{objectToAtrributes item}} class="home-infoblock-link">
				<img class="home-infoblock-image"
					src="{{getThemeAssetsPathWithDefault image 'img/banner-bottom-home-1.jpg'}}" alt="" />
