...
<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
	...
	{{else}}
	<a href="#" class="facets-faceted-navigation-item-facet-group-expander {{#if isCollapsed}}collapsed{{/if}}" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{facetDisplayName}}">
