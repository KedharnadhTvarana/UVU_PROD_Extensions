<fieldset class="paymentinstrument-creditcard-edit-form">
	...
	<div class="paymentinstrument-creditcard-edit-form">
		<label class="paymentinstrument-creditcard-edit-form-checkbox">
			...
			{{#if ccdefault}} <i class="paymentinstrument-creditcard-edit-form-info-icon" data-toggle="tooltip" tabindex="0" title="{{translate 'You need to have at least one card selected by default'}}"></i> {{/if}}
		</label>
	</div>
	{{/if}}
