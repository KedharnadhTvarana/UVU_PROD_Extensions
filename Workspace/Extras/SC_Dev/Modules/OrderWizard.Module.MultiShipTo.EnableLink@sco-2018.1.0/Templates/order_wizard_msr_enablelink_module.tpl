<div class="order-wizard-msr-enablelink-module">
	...
	{{#unless isMultiShipToEnabled}}
		<i class="order-wizard-msr-enablelink-module-link-icon" data-toggle="tooltip" tabindex="0" title="" data-original-title="{{translate 'Click here if you want to divide your order and ship it to multiple addresses. All your data will be saved.'}}" ></i>
	{{/unless}}
</div>
