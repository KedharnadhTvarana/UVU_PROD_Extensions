...
<a class="address-details-new-address" href="/addressbook/new" data-toggle="show-in-modal" role="button">
		...
		<div class="address-details-accordion-container">
			<div class="address-details {{#if isSelected}}address-details-selected{{/if}}">
					...
					<address>
						...
						<div
							...
							<p class="address-details-container-multiselect-address-line">
								...
								{{#if showState}}
								<span class="address-details-container-multiselect-address-details-state"
									data-name="state">
									{{state}}
								</span>
								{{/if}}
				...
				<p class="address-details-actions">
					...
					{{#if showRemoveButton}}
					<button class="address-details-action" data-action="remove" data-id="{{internalid}}" {{#if
						isInvalidAddressToRemove}}disabled{{/if}}>
						{{translate 'Remove'}}
					</button>
					{{#if isInvalidAddressToRemove}}
					<i class="address-details-info-icon" tabindex="0" data-toggle="tooltip"
				...
				<div data-type="address-details-error-container">
					<div class="address-details-error-message">{{translate 'Invalid address, please provide the
						following:'}}</div>
