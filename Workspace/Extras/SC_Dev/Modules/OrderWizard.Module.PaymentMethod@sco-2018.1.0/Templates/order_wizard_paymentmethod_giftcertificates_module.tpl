<div class="order-wizard-paymentmethod-giftcertificates-module">
	...
	<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head">
		<button class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle collapsed"
			data-toggle="collapse" data-target="#gift-certificate-form" aria-expanded="false"
			aria-controls="gift-certificate-form">
	...
	<form id="gift-certificate-form" class="order-wizard-paymentmethod-giftcertificates-module-form collapse"
		data-action="gift-certificate-form">
			...
			<fieldset>
				...
				<div class="order-wizard-paymentmethod-giftcertificates-module-form-input-container">
					<input type="text" class="order-wizard-paymentmethod-giftcertificates-module-form-input" name="code"
						aria-label="Apply Gift Certificate">
				</div>
	...
	<table class="order-wizard-paymentmethod-giftcertificates-module-table">
		...
		<tbody class="order-wizard-paymentmethod-giftcertificates-module-table-body"
			data-view="GiftCertificatesRecords"></tbody>
	</table>
...
<script>
	...
	$(document).on('keydown', function (e) {
		if (e.key === "Escape") {
			...
			var miniEstimateContainer = $('.order-wizard-paymentmethod-giftcertificates-module')[0];
			if (miniEstimateContainer && miniEstimateContainer.contains(focusedElement) && !$('.order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle').hasClass('collapsed')) {
				$('.order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle').click();
				$('.order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle').focus(); // Set focus to header close button
